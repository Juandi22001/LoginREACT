...
const Barra = () => {
  ...
  return (
    ...
    <AppBar position="static"  color="transparent"  sx={{ color: grey[100]}} >
        ...
        <Image src="https://github.com/Juandi22001/LoginREACT/blob/main/Imagenes/LogoMenu3.png?raw=true" width={-100} margin-left={200} maxDelay={5} height={180} alt="efe?" />
          ...
          color="primary" onClick={handleOpenUserMenu} sx={{ p: 0 }}>
              <PersonIcon fontSize="large" sx={{ fontSize: 110, color: grey[900] }}    />
              </IconButton>
            </Tooltip>
            <Menu
          ...
          <Grid > 
          <ExitToAppIcon fontSize="large" sx={{ fontSize: 80, color: grey[900] }}    />
          </Grid>
