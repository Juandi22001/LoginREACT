...
export default function TarjetaAdmisiones() {
    ...
    return (
        ...
        <Card css={{ p: "$8", mw: "400px" }}  >
                        ...
                        <>
                            <div class="">
                                <Grid xs={4} sm={11} justify='center' align="center">
                                    <LibraryBooksIcon fontSize="large" color="success"  sx={{ fontSize: 70 ,color: yellow[800]}} />
                                </Grid>
            ...
            <div class="centerCardFooter">
                <Button color="black" onClick={() => MoverAdmisiones()} >Ir a Portal Tramites</Button>
        </div>
            </Card.Footer>
        </Card>
