...
const Barra = () => {
  ...
  return (
    <AppBar position="static" color="success">
      <Container maxWidth="10px" sx={{ color: green[500]}}>
    ...
    <Image src="https://github.com/Juandi22001/LoginREACT/blob/main/Imagenes/logoGeneral.png?raw=true" width={0} margin-left={200} maxDelay={500} height={125} alt="efe?" />
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } ,color: green[500]}}>
          ...
          color="inherit" onClick={handleOpenUserMenu} sx={{ p: 0 }}>
              <PersonOutlineIcon fontSize ="large"   sx={{ fontSize: 85 ,color: green [50]}} />
              </IconButton>
            </Tooltip>
            <Menu
                color='primary'
              ...
              <Button.Group  vertical color="success" bordered >
