...
export default function VerMaestria() {
                        ...
                        <>
                            <div class="">
                                <Grid xs={4} sm={11} justify='center' align="center">
                                    <SchoolIcon fontSize="large"  sx={{ fontSize: 70 ,color: blue[800]}} />
                                </Grid>
 ...
 <Card.Divider />
    ...
    <Text  color="primary" css={{ lineHeight: "$xs", padding: '$2 $3' }}>
            ...
            <div class="centerCardFooter">
                ...
                <Button color="primary" onClick={() => VerMaestria()} >Ir a Portal Tramites</Button>
                </div>
            </Card.Footer>
        </Card>
