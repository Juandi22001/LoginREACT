...
import { Card, Grid, Row,Col, Button, Text, Modal, useModal, Collapse ,Avatar} from "@nextui-org/react";
                ...
                <Card.Body css={{ p: 5, justifyItems: "center" }}>
                    ...
                    >
                       Nombre
                        ...
                        <Text css={{ lineHeight: "$xs", color: "$blue600" ,padding: '$2 $2'}}>
                            {auth.Nombre}
                        </Text>
...
<Modal.Footer>
    ...
    <Button auto ghost color="inherit" onClick={() => setVisible(false)}>
        salir
    </Button>
</Modal.Footer>
</div>
...
/*
  ...
  <Collapse.Group>
      <Collapse title="Nombre" shadow color="success">
        <Text>
        {auth.Nombre}
        </Text>
      </Collapse>
   ...
   <Grid xs={4} sm={6} align="center">
    ...
    <Collapse.Group>
      ...
      <Collapse title="Edad"  shadow   css={{
          color: '$green800',
          fontSize: '$sm',
          padding: '$8 $8'
        }}>
